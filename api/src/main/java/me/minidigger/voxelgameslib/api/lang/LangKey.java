...
public enum LangKey {
    ...
    LANG_UNKNOWN("{red}Unknown language {yellow}{lang}{red}! Use {yellow}/lang{red} to see which languages are available!", "lang"),
    LANG_UPDATE("{green}You are now receiving messages in {yellow}{lang}{green}!", "lang"),
    LANG_NOT_ENABLED("{red}However, {yellow}{lang}{red} is not enabled on this server. Ask the admins very kindly to enable it!", "lang"),
    ...
    VOTE_MESSAGE_MAP("{aqua}#{yellow}{num}{aqua}: {yellow}{name}{aqua} by {yellow}{author}", "num", "name", "author"),
    ...
    WORLD_CREATOR_AUTHOR_SET("{green}Author set to {yellow}{author}{green}.{aqua} Select the gamemodes this map should be played on.", "author"),
    ...
    WORLD_CREATOR_ENTER_AUTHOR("{green}Name set to {yellow}{name}{green},{aqua} click here and enter the author", "name"),
    WORLD_CREATOR_ENTER_DISPLAY_NAME("{green}Radius set.{aqua} Click here and enter the display name for the world."),
    WORLD_CREATOR_ENTER_CENTER("{green}World loaded.{aqua} Walk to the middle of the world and click here to mark it."),
    WORLD_CREATOR_ENTER_RADIUS("{green}Center set.{aqua} Click here and enter the radius of this world (in which we should search for markers and load chunks and stuff)."),
    WORLD_CREATOR_ENTER_WORLD_NAME("{aqua}Click here and enter the name of the world that you want to create."),
