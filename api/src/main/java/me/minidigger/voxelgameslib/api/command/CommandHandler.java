...
public class CommandHandler implements Handler {
     ...
     * @param method       the method that will be called on execution
     * @param object       the instance of the class that has the method
     * @param remove       if the internal lists should be accessed, used to avoid CMEs
     */
     ...
     * @param remove       if the internal lists should be accessed, used to avoid CMEs
     */
    protected void unregisterCompleter(@Nonnull String commandLabel, @Nonnull CompleterInfo info, @Nonnull Method method, @Nonnull Object object, boolean remove) {
        if (remove) {
