...
public class Player<T> implements IPlayer, ISupportPartialPlay, ISupportPartialUpdate {
     ...
     *
     * @param id                    The identifier for the player, such as a name.
     * @param partialPlayPercentage The weight percentage to give this player when calculating a new
     *                              rank.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(player.getPartialPlayPercentage(), getPartialPlayPercentage()) != 0)
            return false;
        if (Double.compare(player.getPartialUpdatePercentage(), getPartialUpdatePercentage()) != 0)
            return false;
